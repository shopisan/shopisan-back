...
export default function GeneralsConditions(){
    ...
    return(
        <div className={classes.general}>
            ...
            <br></br>
            En cas de différend et à défaut d'accord amiable, le litige sera porté devant les tribunaux de l'arrondissement j udiciaire où shopisan a son siège social.
            </Typography>
